...
-- Step 1: Drop existing RLS policies on chat_conversations (using exact names)
...
-- Step 4: Create new restrictive RLS policies for chat_conversations (no OR user_id IS NULL)
...
-- Step 5: Create new restrictive RLS policies for chat_messages (remove OR user_id IS NULL check)
